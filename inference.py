...
def __main__():
    ...
    parser.add_argument(
        "--data_path_test",
        default='/media/ghasem/Extreme SSD/deep_project/Cardiac/PsudoCT/external_ge/NIfTI/',
        type=Path,
        help="Path to the training set",
    )
    parser.add_argument("--exp_dir", default='/media/ghasem/Extreme SSD/deep_project/Cardiac/PsudoCT/test_model/',type=Path, help="output directory to save test images, same as train")
    parser.add_argument(
        "--exp",
        default='external_ge',
        type=str,
